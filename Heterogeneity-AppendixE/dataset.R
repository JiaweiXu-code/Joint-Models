...
##################### general case ######################
JMD = function(seed, v, k = 2.7, q = 1, measures = 9, npieces = 1, knots = c(1.91, 2.43, 3.00, 3.80), 
               sigma = 0.65642581, p = c(0.5,0.5), gamma = c(0.26634693,0,-0.3489892,0.25,-0.03393003), 
               beta = -0.3, alpha = c(-0.2,0.76753173), mSigma = 0.71202084/2,
...
fname1 = paste("/pine/scr/j/i/jiawei/rev11/sigma/0.356/data/data",node.idx,".csv",sep = "")
