...
##################### general case ######################
JMD = function(seed, v, k = 3, nlinear = 4, measures = 9, npieces = 5, eta = 1, maxt = 10, censor = 5, 
               censorp = 0.1, interval = 0.001, pknots = c(0.25,0.75,1.25), knots = c(1.91, 2.43, 3.00, 3.80), 
...
fname1 = paste("/pine/scr/j/i/jiawei/rev11/censor/10/data/data",node.idx,".csv",sep = "")
