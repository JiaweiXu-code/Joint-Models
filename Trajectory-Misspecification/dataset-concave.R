...
##################### general case ######################
JMD = function(seed, v, k = 3.45, nlinear = 6, measures = 9, npieces = 5, eta = 1, maxt = 10, censor = 5, 
...
fname1 = paste("/pine/scr/j/i/jiawei/rev11/mis/concave/data/data",node.idx,".csv",sep = "")
