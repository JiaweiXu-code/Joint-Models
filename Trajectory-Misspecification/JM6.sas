libname lib "/pine/scr/j/i/jiawei/rev11/mis/leveloff/means6";

data all&sysparm.;
infile "/pine/scr/j/i/jiawei/rev11/mis/leveloff/data/data&sysparm..csv" delimiter = ',';
...
by sim id;
  t1 = min(time,0.25);
  t2 = min(max(time-0.25,0),(0.5-0.25));
  t3 = min(max(time-0.5,0),(0.75-0.5));
  t4 = min(max(time-0.75,0),(1-0.75));
  t5 = min(max(time-1,0),(1.25-1));
  t6 = max(time-1.25, 0);
...
by sim;
 model measure = t1 t2 t3 t4 t5 t6 trt t1*trt t2*trt t3*trt t4*trt t5*trt t6*trt nodegrp / solution;
...
random random_intercept ~ normal(0,v11) subject=id;
  ...
  ** longitudinal component;
    muLong = random_intercept + gamma_intercept + gamma_t1*t1 + gamma_t2*t2 + gamma_t3*t3 + gamma_t4*t4 + gamma_t5*t5 + gamma_t6*t6 + gamma_trt*trt + (gamma_t1_trt*t1+gamma_t2_trt*t2+gamma_t3_trt*t3+gamma_t4_trt*t4+gamma_t5_trt*t5+gamma_t6_trt*t6)*trt + gamma_nodegrp*nodegrp;
   ...
   if surv_like = 1 then do;
	...
	A5 = A4 + beta*(gamma_t4 + gamma_t4_trt*trt)*(L4-L3);
	A6 = A5 + beta*(gamma_t5 + gamma_t5_trt*trt)*(L5-L4);
    ...
    B2 = beta*(gamma_t2 + gamma_t2_trt*trt);
  	...
  	B5 = beta*(gamma_t5 + gamma_t5_trt*trt);
  	B6 = beta*(gamma_t6 + gamma_t6_trt*trt);
	...
	** when beta_joint approximation zero the hazard is constant as a function of time and hence the likelihood contribution is different;	  
	...
	if t <= k1 then do;
	    ...
	    else if t <= L4 then logLike = logLike + censorship*(alpha_s1+A4+B4*(t-L3)) - exp(alpha_s1+A1)*(exp(B1*L1)-1)/B1 - exp(alpha_s1+A2)*(exp(B2*(L2-L1))-1)/B2 - exp(alpha_s1+A3)*(exp(B3*(L3-L2))-1)/B3 - exp(alpha_s1+A4)*(exp(B4*(t-L3))-1)/B4;
	    else if t <= L5 then logLike = logLike + censorship*(alpha_s1+A5+B5*(t-L4)) - exp(alpha_s1+A1)*(exp(B1*L1)-1)/B1 - exp(alpha_s1+A2)*(exp(B2*(L2-L1))-1)/B2 - exp(alpha_s1+A3)*(exp(B3*(L3-L2))-1)/B3 - exp(alpha_s1+A4)*(exp(B4*(L4-L3))-1)/B4 - exp(alpha_s1+A5)*(exp(B5*(t-L4))-1)/B5;
            else logLike = logLike + censorship*(alpha_s1+A6+B6*(t-L5)) - exp(alpha_s1+A1)*(exp(B1*L1)-1)/B1 - exp(alpha_s1+A2)*(exp(B2*(L2-L1))-1)/B2 - exp(alpha_s1+A3)*(exp(B3*(L3-L2))-1)/B3 - exp(alpha_s1+A4)*(exp(B4*(L4-L3))-1)/B4 - exp(alpha_s1+A5)*(exp(B5*(L5-L4))-1)/B5 - exp(alpha_s1+A6)*(exp(B6*(t-L5))-1)/B6;
        end;

	else if t <= k2 then logLike = logLike + censorship*(alpha_s2+A6+B6*(t-L5)) - exp(alpha_s2+A6)/B6*(exp(B6*(t-L5))-exp(B6*(k1-L5))) - exp(alpha_s1+A1)*(exp(B1*L1)-1)/B1 - exp(alpha_s1+A2)*(exp(B2*(L2-L1))-1)/B2 - exp(alpha_s1+A3)*(exp(B3*(L3-L2))-1)/B3 - exp(alpha_s1+A4)*(exp(B4*(L4-L3))-1)/B4 - exp(alpha_s1+A5)*(exp(B5*(L5-L4))-1)/B5 - exp(alpha_s1+A6)*(exp(B6*(k1-L5))-1)/B6;
        else if t <= k3 then logLike = logLike + censorship*(alpha_s3+A6+B6*(t-L5)) - exp(alpha_s3+A6)/B6*(exp(B6*(t-L5))-exp(B6*(k2-L5))) - exp(alpha_s2+A6)/B6*(exp(B6*(k2-L5))-exp(B6*(k1-L5))) - exp(alpha_s1+A1)*(exp(B1*L1)-1)/B1 - exp(alpha_s1+A2)*(exp(B2*(L2-L1))-1)/B2 - exp(alpha_s1+A3)*(exp(B3*(L3-L2))-1)/B3 - exp(alpha_s1+A4)*(exp(B4*(L4-L3))-1)/B4 - exp(alpha_s1+A5)*(exp(B5*(L5-L4))-1)/B5 - exp(alpha_s1+A6)*(exp(B6*(k1-L5))-1)/B6;
	else if t <= k4 then logLike = logLike + censorship*(alpha_s4+A6+B6*(t-L5)) - exp(alpha_s4+A6)/B6*(exp(B6*(t-L5))-exp(B6*(k3-L5))) - exp(alpha_s3+A6)/B6*(exp(B6*(k3-L5))-exp(B6*(k2-L5))) - exp(alpha_s2+A6)/B6*(exp(B6*(k2-L5))-exp(B6*(k1-L5))) - exp(alpha_s1+A1)*(exp(B1*L1)-1)/B1 - exp(alpha_s1+A2)*(exp(B2*(L2-L1))-1)/B2 - exp(alpha_s1+A3)*(exp(B3*(L3-L2))-1)/B3 - exp(alpha_s1+A4)*(exp(B4*(L4-L3))-1)/B4 - exp(alpha_s1+A5)*(exp(B5*(L5-L4))-1)/B5 - exp(alpha_s1+A6)*(exp(B6*(k1-L5))-1)/B6;
        else logLike = logLike + censorship*(alpha_s5+A6+B6*(t-L5)) - exp(alpha_s5+A6)/B6*(exp(B6*(t-L5))-exp(B6*(k4-L5))) - exp(alpha_s4+A6)/B6*(exp(B6*(k4-L5))-exp(B6*(k3-L5))) - exp(alpha_s3+A6)/B6*(exp(B6*(k3-L5))-exp(B6*(k2-L5))) - exp(alpha_s2+A6)/B6*(exp(B6*(k2-L5))-exp(B6*(k1-L5))) - exp(alpha_s1+A1)*(exp(B1*L1)-1)/B1 - exp(alpha_s1+A2)*(exp(B2*(L2-L1))-1)/B2 - exp(alpha_s1+A3)*(exp(B3*(L3-L2))-1)/B3 - exp(alpha_s1+A4)*(exp(B4*(L4-L3))-1)/B4 - exp(alpha_s1+A5)*(exp(B5*(L5-L4))-1)/B5 - exp(alpha_s1+A6)*(exp(B6*(k1-L5))-1)/B6;
    end;
	...
	** average hazard ratio;
	...
	del7 = max( L3, min( (beta*L3*(gamma_t4_trt-gamma_t3_trt)+beta*L2*(gamma_t3_trt-gamma_t2_trt)+beta*L1*(gamma_t2_trt-gamma_t1_trt)-(beta*gamma_trt + alpha_trt))/(beta*gamma_t4_trt), L4) );
	del8 = min( L4, max( (beta*L3*(gamma_t4_trt-gamma_t3_trt)+beta*L2*(gamma_t3_trt-gamma_t2_trt)+beta*L1*(gamma_t2_trt-gamma_t1_trt)-(beta*gamma_trt + alpha_trt))/(beta*gamma_t4_trt), L3) );
	del9 = max( L4, min( (beta*L4*(gamma_t5_trt-gamma_t4_trt)+beta*L3*(gamma_t4_trt-gamma_t3_trt)+beta*L2*(gamma_t3_trt-gamma_t2_trt)+beta*L1*(gamma_t2_trt-gamma_t1_trt)-(beta*gamma_trt + alpha_trt))/(beta*gamma_t5_trt), L5) );
	del10 = min( L5, max( (beta*L4*(gamma_t5_trt-gamma_t4_trt)+beta*L3*(gamma_t4_trt-gamma_t3_trt)+beta*L2*(gamma_t3_trt-gamma_t2_trt)+beta*L1*(gamma_t2_trt-gamma_t1_trt)-(beta*gamma_trt + alpha_trt))/(beta*gamma_t5_trt), L4) );
	del11 = max( L5, min( (beta*L5*(gamma_t6_trt-gamma_t5_trt)+beta*L4*(gamma_t5_trt-gamma_t4_trt)+beta*L3*(gamma_t4_trt-gamma_t3_trt)+beta*L2*(gamma_t3_trt-gamma_t2_trt)+beta*L1*(gamma_t2_trt-gamma_t1_trt)-(beta*gamma_trt + alpha_trt))/(beta*gamma_t6_trt), t0) );
	del12 = min( t0, max( (beta*L5*(gamma_t6_trt-gamma_t5_trt)+beta*L4*(gamma_t5_trt-gamma_t4_trt)+beta*L3*(gamma_t4_trt-gamma_t3_trt)+beta*L2*(gamma_t3_trt-gamma_t2_trt)+beta*L1*(gamma_t2_trt-gamma_t1_trt)-(beta*gamma_trt + alpha_trt))/(beta*gamma_t6_trt), L5) );
        ...
        phi4 = sign(beta*gamma_t4_trt)*( (beta*gamma_t1_trt*L1+beta*gamma_t2_trt*(L2-L1)+beta*gamma_t3_trt*(L3-L2)+(beta*gamma_trt + alpha_trt))**3 + (beta*gamma_t4_trt*(L4-L3)+beta*gamma_t3_trt*(L3-L2)+beta*gamma_t2_trt*(L2-L1)+beta*gamma_t1_trt*L1+(beta*gamma_trt + alpha_trt))**3 - (beta*gamma_t4_trt*(del7-L3)+beta*gamma_t3_trt*(L3-L2)+beta*gamma_t2_trt*(L2-L1)+beta*gamma_t1_trt*L1+(beta*gamma_trt + alpha_trt))**3 - (beta*gamma_t4_trt*(del8-L3)+beta*gamma_t3_trt*(L3-L2)+beta*gamma_t2_trt*(L2-L1)+beta*gamma_t1_trt*L1+(beta*gamma_trt + alpha_trt))**3 )/(3*beta*gamma_t4_trt);
        c4 = sign(beta*gamma_t4_trt)*( beta*gamma_t4_trt*(L4-L3)**2/2 - beta*gamma_t4_trt*(del7-L3)**2/2 - beta*gamma_t4_trt*(del8-L3)**2/2 + (beta*gamma_t3_trt*(L3-L2)+beta*gamma_t2_trt*(L2-L1)+beta*gamma_t1_trt*L1+(beta*gamma_trt + alpha_trt))*(L4+L3-del7-del8) );
        phi5 = sign(beta*gamma_t5_trt)*( (beta*gamma_t1_trt*L1+beta*gamma_t2_trt*(L2-L1)+beta*gamma_t3_trt*(L3-L2)+beta*gamma_t4_trt*(L4-L3)+(beta*gamma_trt + alpha_trt))**3 + (beta*gamma_t5_trt*(L5-L4)+beta*gamma_t4_trt*(L4-L3)+beta*gamma_t3_trt*(L3-L2)+beta*gamma_t2_trt*(L2-L1)+beta*gamma_t1_trt*L1+(beta*gamma_trt + alpha_trt))**3 - (beta*gamma_t5_trt*(del9-L4)+beta*gamma_t4_trt*(L4-L3)+beta*gamma_t3_trt*(L3-L2)+beta*gamma_t2_trt*(L2-L1)+beta*gamma_t1_trt*L1+(beta*gamma_trt + alpha_trt))**3 - (beta*gamma_t5_trt*(del10-L4)+beta*gamma_t4_trt*(L4-L3)+beta*gamma_t3_trt*(L3-L2)+beta*gamma_t2_trt*(L2-L1)+beta*gamma_t1_trt*L1+(beta*gamma_trt + alpha_trt))**3 )/(3*beta*gamma_t5_trt);
        c5 = sign(beta*gamma_t5_trt)*( beta*gamma_t5_trt*(L5-L4)**2/2 - beta*gamma_t5_trt*(del9-L4)**2/2 - beta*gamma_t5_trt*(del10-L4)**2/2 + (beta*gamma_t4_trt*(L4-L3)+beta*gamma_t3_trt*(L3-L2)+beta*gamma_t2_trt*(L2-L1)+beta*gamma_t1_trt*L1+(beta*gamma_trt + alpha_trt))*(L5+L4-del9-del10) );
        phi6 = sign(beta*gamma_t6_trt)*( (beta*gamma_t1_trt*L1+beta*gamma_t2_trt*(L2-L1)+beta*gamma_t3_trt*(L3-L2)+beta*gamma_t4_trt*(L4-L3)+beta*gamma_t5_trt*(L5-L4)+(beta*gamma_trt + alpha_trt))**3 + (beta*gamma_t6_trt*(t0-L5)+beta*gamma_t5_trt*(L5-L4)+beta*gamma_t4_trt*(L4-L3)+beta*gamma_t3_trt*(L3-L2)+beta*gamma_t2_trt*(L2-L1)+beta*gamma_t1_trt*L1+(beta*gamma_trt + alpha_trt))**3 - (beta*gamma_t6_trt*(del11-L5)+beta*gamma_t5_trt*(L5-L4)+beta*gamma_t4_trt*(L4-L3)+beta*gamma_t3_trt*(L3-L2)+beta*gamma_t2_trt*(L2-L1)+beta*gamma_t1_trt*L1+(beta*gamma_trt + alpha_trt))**3 - (beta*gamma_t6_trt*(del12-L5)+beta*gamma_t5_trt*(L5-L4)+beta*gamma_t4_trt*(L4-L3)+beta*gamma_t3_trt*(L3-L2)+beta*gamma_t2_trt*(L2-L1)+beta*gamma_t1_trt*L1+(beta*gamma_trt + alpha_trt))**3 )/(3*beta*gamma_t6_trt);
        c6 = sign(beta*gamma_t6_trt)*( beta*gamma_t6_trt*(t0-L5)**2/2 - beta*gamma_t6_trt*(del11-L5)**2/2 - beta*gamma_t6_trt*(del12-L5)**2/2 + (beta*gamma_t5_trt*(L5-L4)+beta*gamma_t4_trt*(L4-L3)+beta*gamma_t3_trt*(L3-L2)+beta*gamma_t2_trt*(L2-L1)+beta*gamma_t1_trt*L1+(beta*gamma_trt + alpha_trt))*(t0+L5-del11-del12) );

       extra = t0*(beta*gamma_trt + alpha_trt) + beta*( gamma_t1_trt*L1**2/2+gamma_t2_trt*(L2-L1)**2/2+gamma_t3_trt*(L3-L2)**2/2+gamma_t4_trt*(L4-L3)**2/2+gamma_t5_trt*(L5-L4)**2/2+gamma_t6_trt*(t0-L5)**2/2+gamma_t1_trt*L1*(t0-L1)+gamma_t2_trt*(L2-L1)*(t0-L2)+gamma_t3_trt*(L3-L2)*(t0-L3)+gamma_t4_trt*(L4-L3)*(t0-L4)+gamma_t5_trt*(L5-L4)*(t0-L5) );
       eta = 1e-3;

 estimate "Overall Effect eta" (phi1+phi2+phi3+phi4+phi5+phi6+extra*eta)/(c1+c2+c3+c4+c5+c6+eta*t0);
