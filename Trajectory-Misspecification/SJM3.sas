libname lib "/pine/scr/j/i/jiawei/rev11/mis/concave/means_nore";
...
bounds sig_residual>1e-3;
  ...
  ** longitudinal component;
    muLong = gamma_intercept + gamma_t1*t1 + gamma_t2*t2 + gamma_t3*t3 + gamma_trt*trt + (gamma_t1_trt*t1+gamma_t2_trt*t2+gamma_t3_trt*t3)*trt + gamma_nodegrp*nodegrp;
