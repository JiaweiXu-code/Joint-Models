libname lib "/pine/scr/j/i/jiawei/rev11/mis/concave/means_nore6";

data all&sysparm.;
infile "/pine/scr/j/i/jiawei/rev11/mis/concave/data/data&sysparm..csv" delimiter = ',';
...
bounds sig_residual>1e-3; 
  ...
  ** longitudinal component;
    muLong = gamma_intercept + gamma_t1*t1 + gamma_t2*t2 + gamma_t3*t3 + gamma_t4*t4 + gamma_t5*t5 + gamma_t6*t6 + gamma_trt*trt + (gamma_t1_trt*t1+gamma_t2_trt*t2+gamma_t3_trt*t3+gamma_t4_trt*t4+gamma_t5_trt*t5+gamma_t6_trt*t6)*trt + gamma_nodegrp*nodegrp;
