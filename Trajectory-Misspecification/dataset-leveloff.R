...
##################### general case ######################
JMD = function(seed, v, k = 3.5, nlinear = 6, measures = 9, npieces = 5, eta = 1, maxt = 10, censor = 5, 
               censorp = 0.05, interval = 0.001, pknots = c(0.25,0.5,0.75,1,1.25), knots = c(1.91, 2.43, 3.00, 3.80), 
               sigma = 0.65624812, p = c(0.5,0.5), mSigma = 0.71202209, gamma = c(0.26954762,0,-0.03410496),
               plinear = c(0,
                           0,
                           0,
                           0,
...
fname1 = paste("/pine/scr/j/i/jiawei/rev11/mis/leveloff/data/data",node.idx,".csv",sep = "")
